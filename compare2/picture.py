...
if __name__ == '__main__':
    ...
    n=10
    iter=200
    D1_1=np.transpose(readFile('paper_algorithm1_(8)_TAU2.txt'))
    D2_1=np.transpose(readFile('paper_algorithm1_(7)_TAU2.txt'))
   ...
   #Next
    ...
    D1_2=np.transpose(readFile('paper_algorithm1_(8)_TAU3.txt'))
    D2_2=np.transpose(readFile('paper_algorithm1_(7)_TAU3.txt'))
   ...
   #Next
    D1_3=np.transpose(readFile('paper_algorithm1_(8)_TAU4.txt'))
    D2_3=np.transpose(readFile('paper_algorithm1_(7)_TAU4.txt'))
   ...
   #Next
    ...
    D1_4=np.transpose(readFile('paper_algorithm1_(8)_TAU5.txt'))
    D2_4=np.transpose(readFile('paper_algorithm1_(7)_TAU5.txt'))
   ...
   #Next
    D1_5=np.transpose(readFile('paper_algorithm1_(8)_TAU6.txt'))
    D2_5=np.transpose(readFile('paper_algorithm1_(7)_TAU6.txt'))
   ...
   #Next
    ...
    plt.semilogy(x5_1,y5_1,label='Algorithm 2',color='k',linewidth=1.5,linestyle='-')
    plt.semilogy(x2_1,y2_1,label='Algorithm 1 with Universal Stepsizes',color='y',linewidth=1.5,linestyle='-.')
    plt.semilogy(x3_1,y3_1,label='Qin et al. (2024)',color='r',linewidth=1.5,linestyle='--')
    plt.semilogy(x4_1,y4_1,label='Khaled et al. (2020)',color='g',linewidth=1.5,linestyle=':')
    plt.semilogy(x6_1,y6_1,label='Mitra et al. (2021b)',color='m',linewidth=1.5,linestyle='dashed')
    plt.semilogy(x7_1,y7_1,label='Mukherjee et al. (2024)',color='c',linewidth=1.5,linestyle='dashdot')
    plt.semilogy(x_1,y_1,label='Algorithm 1 with Local Stepsizes', color='b',linewidth=1.5,linestyle='solid')
    ...
    f2=plt.subplot(3, 2, 3)
    
    plt.semilogy(x5_2,y5_2,label='Algorithm 2',color='k',linewidth=1.5,linestyle='-')
    plt.semilogy(x2_2,y2_2,label='Algorithm 1 with Universal Stepsizes',color='y',linewidth=1.5,linestyle='-.')
    plt.semilogy(x3_2,y3_2,label='Qin et al. (2024)',color='r',linewidth=1.5,linestyle='--')
    plt.semilogy(x4_2,y4_2,label='Khaled et al. (2020)',color='g',linewidth=1.5,linestyle=':')
    plt.semilogy(x6_2,y6_2,label='Mitra et al. (2021b)',color='m',linewidth=1.5,linestyle='dashed')
    plt.semilogy(x7_2,y7_2,label='Mukherjee et al. (2024)',color='c',linewidth=1.5,linestyle='dashdot')
    plt.semilogy(x_2,y_2,label='Algorithm 1 with Local Stepsizes', color='b',linewidth=1.5,linestyle='solid')
    ...
    f3=plt.subplot(3, 2, 4)
    
    plt.semilogy(x5_3,y5_3,label='Algorithm 2',color='k',linewidth=1.5,linestyle='-')
    plt.semilogy(x2_3,y2_3,label='Algorithm 1 with Universal Stepsizes',color='y',linewidth=1.5,linestyle='-.')
    plt.semilogy(x3_3,y3_3,label='Qin et al. (2024)',color='r',linewidth=1.5,linestyle='--')
    plt.semilogy(x4_3,y4_3,label='Khaled et al. (2020)',color='g',linewidth=1.5,linestyle=':')
    plt.semilogy(x6_3,y6_3,label='Mitra et al. (2021b)',color='m',linewidth=1.5,linestyle='dashed')
    plt.semilogy(x7_3,y7_3,label='Mukherjee et al. (2024)',color='c',linewidth=1.5,linestyle='dashdot')
    plt.semilogy(x_3,y_3,label='Algorithm 1 with Local Stepsizes', color='b',linewidth=1.5,linestyle='solid')
    ...
    f4=plt.subplot(3, 2, 5)
    
    plt.semilogy(x7_4,y7_4,label='Mukherjee et al. (2024)',color='c',linewidth=1.5,linestyle='dashdot')
    plt.semilogy(x6_4,y6_4,label='Mitra et al. (2021b)',color='m',linewidth=1.5,linestyle='dashed')
    plt.semilogy(x5_4,y5_4,label='Algorithm 2',color='k',linewidth=1.5,linestyle='-')
    plt.semilogy(x2_4,y2_4,label='Algorithm 1 with Universal Stepsizes',color='y',linewidth=1.5,linestyle='-.')
    plt.semilogy(x4_4,y4_4,label='Khaled et al. (2020)',color='g',linewidth=1.5,linestyle=':')
    plt.semilogy(x3_4,y3_4,label='Qin et al. (2024)',color='r',linewidth=1.5,linestyle='--')
    plt.semilogy(x_4,y_4,label='Algorithm 1 with Local Stepsizes', color='b',linewidth=1.5,linestyle='solid')
    ...
    f5=plt.subplot(3, 2, 6)
    
    plt.semilogy(x7_5,y7_5,label='Mukherjee et al. (2024)',color='c',linewidth=1.5,linestyle='dashdot')
    plt.semilogy(x6_5,y6_5,label='Mitra et al. (2021b)',color='m',linewidth=1.5,linestyle='dashed')
    plt.semilogy(x5_5,y5_5,label='Algorithm 2',color='k',linewidth=1.5,linestyle='-')
    plt.semilogy(x2_5,y2_5,label='Algorithm 1 with Universal Stepsizes',color='y',linewidth=1.5,linestyle='-.')
    plt.semilogy(x4_5,y4_5,label='Khaled et al. (2020)',color='g',linewidth=1.5,linestyle=':')
    plt.semilogy(x3_5,y3_5,label='Qin et al. (2024)',color='r',linewidth=1.5,linestyle='--')
    plt.semilogy(x_5,y_5,label='Algorithm 1 with Local Stepsizes', color='b',linewidth=1.5,linestyle='solid')
    
    f5.set_title(r'$\tau=6$',fontsize=20)
    plt.legend(loc=2, bbox_to_anchor=(-0.05,3.24),borderaxespad = 0,prop = {'size':16})
    plt.grid()
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    ...
    plt.savefig(fname="compare2_all.eps",format="eps", bbox_inches='tight')
    plt.savefig("compare2_all.jpg")
    plt.show() 
