...
if __name__ == '__main__':
   ...
   #Next
    ...
    plt.plot(x3_1,y3_1,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_1,y2_1,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_1,y_1,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
    plt.legend(loc = 0, prop = {'size':13.3})
    plt.grid()
    ...
    plt.plot(x3_2,y3_2,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_2,y2_2,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_2,y_2,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
    plt.grid()
    ...
    plt.plot(x3_3,y3_3,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_3,y2_3,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_3,y_3,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
    ...
    plt.plot(x3_4,y3_4,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_4,y2_4,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_4,y_4,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
    ...
    plt.plot(x3_5,y3_5,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_5,y2_5,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_5,y_5,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
    ...
    plt.plot(x3_6,y3_6,label='Mitra et al. (2021a)',color='y',linewidth=1.1,linestyle='--')
    plt.plot(x2_6,y2_6,label='Mitra et al. (2021b)',color='r',linewidth=1.1,linestyle='-.')
    plt.plot(x_6,y_6,label='Algorithm 2', color='b',linewidth=1.1,linestyle='solid')
