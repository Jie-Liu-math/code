...
if __name__ == '__main__':
    ...
    plt.semilogy(x2_1,y2_1,label='Global Stepsize',color='r',linewidth=1.5,linestyle=':')
    plt.semilogy(x_1,y_1,label='Local Stepsize',color='b',linewidth=1.5,linestyle='-.')
    plt.legend(loc = 0, prop = {'size':19})
    plt.grid()
    f1.set_title(r'$\rho=1$',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    
    f2=plt.subplot(3, 2, 2)
    
    plt.semilogy(x2_2,y2_2,label='Global Stepsize',color='r',linewidth=1.5,linestyle=':')
    plt.semilogy(x_2,y_2,label='Local Stepsize',color='b',linewidth=1.5,linestyle='-.')
    plt.legend(loc = 0, prop = {'size':19})
    plt.grid()
    f2.set_title(r'$\rho=1.5$',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    
    f3=plt.subplot(3, 2, 3)
    
    plt.semilogy(x2_3,y2_3,label='Global Stepsize',color='r',linewidth=1.5,linestyle=':')
    plt.semilogy(x_3,y_3,label='Local Stepsize',color='b',linewidth=1.5,linestyle='-.')
    plt.legend(loc = 0, prop = {'size':19})
    plt.grid()
    f3.set_title(r'$\rho=2$',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    
    f4=plt.subplot(3, 2, 4)
    
    plt.semilogy(x2_4,y2_4,label='Global Stepsize',color='r',linewidth=1.5,linestyle=':')
    plt.semilogy(x_4,y_4,label='Local Stepsize',color='b',linewidth=1.5,linestyle='-.')
    plt.legend(loc = 0, prop = {'size':19})
    plt.grid()
    f4.set_title(r'$\rho=2.5$',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    
    f5=plt.subplot(3, 2, 5)
    
    plt.semilogy(x2_5,y2_5,label='Global Stepsize',color='r',linewidth=1.5,linestyle=':')
    plt.semilogy(x_5,y_5,label='Local Stepsize',color='b',linewidth=1.5,linestyle='-.')
    plt.legend(loc = 0, prop = {'size':19})
    plt.grid()
    f5.set_title(r'$\rho=3$',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Errors',fontsize=15)
    
    f6=plt.subplot(3, 2, 6)
    
    plt.plot(x,y,label=r'$\rho=1$',color='y',linewidth=1.5,linestyle='-.')
    plt.plot(x2,y2,label=r'$\rho=1.5$',color='g',linewidth=1.5,linestyle=':')
    plt.plot(x3,y3,label=r'$\rho=2$',color='r',linewidth=1.5,linestyle='--')
    plt.plot(x4,y4,label=r'$\rho=2.5$',color='c',linewidth=1.5,linestyle='-')
    plt.plot(x5,y5,label=r'$\rho=3$',color='b',linewidth=1.5,linestyle='solid')
    
    plt.legend(loc = 0, prop = {'size':18})
    plt.grid()
    f6.set_title('Ratio Comparisons',fontsize=20)
    plt.xlabel('Times t',fontsize=15)
    plt.ylabel('Ratios',fontsize=15)
    
    
    plt.savefig(fname="compare3_tau_all.eps",format="eps", bbox_inches='tight')
    plt.savefig("compare3_tau_all.jpg")
    plt.show() 
